...
# Keys/urls for authentication
ltapikey = 'XlL-0YMW8CtRl9Ga9HeulhOeJ1pDt-TXM9oF4aQvdnOz'
lturl = 'https://api.us-east.language-translator.watson.cloud.ibm.com/instances/690a5f9f-651a-48ad-b2b1-3db100778966'
sttapikey = 'dmZ9U_6DQlBqRq7O-IirxE4kqaJKKiYfyG4sW73qzzVW'
stturl = 'https://api.us-east.speech-to-text.watson.cloud.ibm.com/instances/1cfa4820-62e0-4692-b4a2-c2b573356e18'
ttsapikey = '2PjjX0TFbLhPRnu1JiOA9tkV4vniG_aZXSmAcMuWjdyo'
ttsurl = 'https://api.us-east.text-to-speech.watson.cloud.ibm.com/instances/b5e2de2b-cb0a-471e-ba7b-bd1c23ad4990'

speech_to_text_key = 'dmZ9U_6DQlBqRq7O-IirxE4kqaJKKiYfyG4sW73qzzVW'
text_to_speech_key = '2PjjX0TFbLhPRnu1JiOA9tkV4vniG_aZXSmAcMuWjdyo'
translate_key = 'XlL-0YMW8CtRl9Ga9HeulhOeJ1pDt-TXM9oF4aQvdnOz'
...
def speech_to_text(file_name, model_id):
    ...
    # stt = SpeechToTextV1(iam_apikey=keys.speech_to_text_key) ORIGINAL
...
def translate(text_to_translate, model):
   ...
   # language_translator = LanguageTranslatorV3(translate_key)
...
def text_to_speech(text_to_speak, voice_to_use, file_name):
    ...
    # tts = TextToSpeechV1(iam_apikey=keys.text_to_speech_key) ORIGINAL
   # tts = TextToSpeechV1(text_to_speech_key)
...
def record_audio(file_name):
    ...
    CHANNELS = 1  # 1 sample per frame (API supports 1 channel)
